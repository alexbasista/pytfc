...
class AdminUsers(Requestor):
    ...
    def list(self, query=None, filters=None, page_number=None, page_size=None,
        ...
        """
        return self.get(url=self._au_endpoint, query=query, filters=filters,
    ...
    def list_all(self, query=None, filters=None, include=None):
        ...
        GET /api/v2/admin/users
        """
        return self._list_all(url=self._au_endpoint, query=query,
